...
[![npm downloads](https://img.shields.io/npm/dt/cordova-plugin-fcm-with-dependecy-updated-updated.svg)](https://www.npmjs.com/package/cordova-plugin-fcm-with-dependecy-updated-updated)
[![npm per month](https://img.shields.io/npm/dm/cordova-plugin-fcm-with-dependecy-updated-updated.svg)](https://www.npmjs.com/package/cordova-plugin-fcm-with-dependecy-updated-updated)
[![npm version](https://img.shields.io/npm/v/cordova-plugin-fcm-with-dependecy-updated-updated.svg)](https://www.npmjs.com/package/cordova-plugin-fcm-with-dependecy-updated-updated)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)
[![GitHub issues](https://img.shields.io/github/issues/andrehtissot/cordova-plugin-fcm-with-dependecy-updated-updated.svg)](https://github.com/andrehtissot/cordova-plugin-fcm-with-dependecy-updated-updated/issues)
[![GitHub forks](https://img.shields.io/github/forks/andrehtissot/cordova-plugin-fcm-with-dependecy-updated-updated.svg)](https://github.com/andrehtissot/cordova-plugin-fcm-with-dependecy-updated-updated/network)
[![GitHub stars](https://img.shields.io/github/stars/andrehtissot/cordova-plugin-fcm-with-dependecy-updated-updated.svg)](https://github.com/andrehtissot/cordova-plugin-fcm-with-dependecy-updated-updated/stargazers)
[![Known Vulnerabilities](https://snyk.io/test/github/andrehtissot/cordova-plugin-fcm-with-dependecy-updated-updated/badge.svg?targetFile=package.json)](https://snyk.io/test/github/andrehtissot/cordova-plugin-fcm-with-dependecy-updated-updated?targetFile=package.json)
...
cordova plugin add cordova-plugin-fcm-with-dependecy-updated-updated
```
...
npm install -g cordova@latest # Version 9 or higher required
npm uninstall @ionic-native/fcm # Ionic support is included and conflicts with @ionic-native's implementation.
ionic cordova plugin add cordova-plugin-fcm-with-dependecy-updated-updated
```
...
- Ionic v5:
```typescript
import { FCM } from "cordova-plugin-fcm-with-dependecy-updated-updated/ionic";
```
- Ionic ngx:
```typescript
import { FCM } from "cordova-plugin-fcm-with-dependecy-updated-updated/ionic/ngx";
```
- Ionic v4 (also works for Ionic v3):
```typescript
import { FCM } from "cordova-plugin-fcm-with-dependecy-updated-updated/ionic/v4";
```
...
https://github.com/andrehtissot/cordova-plugin-fcm-with-dependecy-updated-updated-app-example

### Ionic v3

https://github.com/andrehtissot/cordova-plugin-fcm-with-dependecy-updated-updated-ionic-v3-example

### Ionic v5

https://github.com/andrehtissot/cordova-plugin-fcm-with-dependecy-updated-updated-ionic-v5-example
