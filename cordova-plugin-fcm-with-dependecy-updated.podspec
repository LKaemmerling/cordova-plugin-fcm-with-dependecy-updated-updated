#
#  Be sure to run `pod spec lint cordova-plugin-fcm-with-dependecy-updated-updated.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "cordova-plugin-fcm-with-dependecy-updated-updated"
  spec.version      = "7.8.0"
...
DESC
  ...
  spec.homepage     = "https://github.com/andrehtissot/cordova-plugin-fcm-with-dependecy-updated-updated"
  ...
  spec.source       = { :git => "https://github.com/andrehtissot/cordova-plugin-fcm-with-dependecy-updated-updated.git", :tag => "v#{spec.version}" }
